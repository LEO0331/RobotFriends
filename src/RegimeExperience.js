...
export default function RegimeExperience({ language = 'en', onLanguageChange = () => {} }) {
  ...
  if (route === 'regime') return <SignalDetail language={language} setLanguage={onLanguageChange} navigate={navigate} snapshot={snapshot} />;
  return <><App snapshot={snapshot} language={language} onLanguageChange={onLanguageChange} /><ExposurePeriodPortal /></>;
}
